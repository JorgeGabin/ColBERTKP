...
from colbert.training.training_kpencoder import train


def main():
    parser = Arguments(
        description='Training ColBERTKP encoder-only with <keyphrases, positive passage, negative passage> triples.')
